...
#[derive(Debug)]
pub struct AstroSiteProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AstroSiteProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AstroSite processing");
    
    let mut processor = AstroSiteProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AstroSiteProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AstroSiteProcessor::new(false);
